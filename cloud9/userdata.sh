...
#curl -L https://raw.githubusercontent.com/timmyb824/newrelic-ruby-kata/master/cloud9/userdata.sh | bash
...
#git clone https://github.com/timmyb824/newrelic-ruby-kata /home/ec2-user/newrelic-ruby-kata
